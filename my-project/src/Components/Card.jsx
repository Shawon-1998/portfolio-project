...
const Card = ({ service, description, icon, className }) => {
  return (
    <>
      <div className=" h-65 shadow-[0_0_10px] hover:text-secondary block max-w-sm pt-2 px-2 pb-10  rounded-base items-center hover:scale-110 transition infinity rounded-lg ">
