...
const Card = ({service,description,icon,className}) => {
  return (
    <>
        <div className="bg-primary h-65 shadow-[0_0_100px] hover:text-secondary block max-w-sm p-6  rounded-base items-center hover:scale-110 transition infinity rounded-lg ">
